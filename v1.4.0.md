...
#### Restoration of Virtual Machines in a New Harvester Cluster

In Harvester v1.4.0, each virtual machine backup includes the corresponding virtual machine image, which allows you to easily restore those images in a new cluster. 
