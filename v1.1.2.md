...
If you use Rancher v2.7.2 with Harvester v1.1.1 clusters, you can't select the Harvester cloud provider while deploying guest clusters. See [this issue](https://github.com/harvester/harvester/issues/3750) for more information.

There are two fixes to this issue:
- Upgrade Harvester to v1.1.2.
- Manually patch the `harvester-csi-ccm-versions` setting:
    ```
