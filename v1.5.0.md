...
Harvester v1.5.0 fully supports deployment on hosts with ARM architecture. This includes add-ons, which were previously packaged only for x86_64-based hosts, and upgrade paths for ARM-only clusters. Harvester on ARM is fully tested, stable, and ready for mission-critical workloads.
