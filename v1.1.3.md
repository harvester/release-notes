...
You can [upgrade from v1.1.1 and v1.1.2 to v1.1.3](https://docs.harvesterhci.io/v1.2/upgrade/index).

## Bug Fixes

### General Fixes

- Users that create a namespace and then create volumes in the same namespace are unable to view the new volumes on the Harvester UI. Previously, only the administrator was able to view the new volume data. See [issue #3874](https://github.com/harvester/harvester/issues/3874).
