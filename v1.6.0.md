...
> [!IMPORTANT]
> All new features that use Kube-OVN are considered experimental. The Kube-OVN implementation in Harvester v1.6.0 does not support upgrades, virtual machine live migration, and the Harvester Node Driver for guest cluster provisioning. For more information, see LINK.
...
[Documentation](LINK) | [GitHub issue](https://github.com/harvester/harvester/issues/7397)
...
[Demo](https://youtu.be/4AZ2oQ8Ek_A) | [Documentation](LINK) | [GitHub issue](https://github.com/harvester/harvester/issues/7397)
...
### Known Issues of external Rancher
