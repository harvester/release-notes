...
:cd: https://releases.rancher.com/harvester/v1.3.0/harvester-v1.3.0-amd64-net-install.iso [[Doc](https://docs.harvesterhci.io/v1.3/install/net-install/)]
...
> [!IMPORTANT]
> Starting from v1.3.0, the Harvester installer checks if a hardware meets the [recommended requirements](https://docs.harvesterhci.io/v1.3/install/requirements), and it will stop the installation progress if a hardware can't meet the requirements. If you want to disable this behavior in iPXE installation for testing purposes, please add a `harvester.install.skipchecks=true` kernel parameter when booting the system. For more information, please check the [document](https://docs.harvesterhci.io/v1.3/install/pxe-boot-install#harvesterinstallskipcheckstrue).
...
> [!NOTE]
> We plan to support upgrading from Harvester v1.2.2 to v1.3.0, please wait for v1.2.2 release and upgrade a Harvester cluster to v1.2.2 first before upgrading to v1.3.0.
