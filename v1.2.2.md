...
- [backport v1.2] [ENHANCEMENT] Bump go to v1.21 [#5612](https://github.com/harvester/harvester/issues/5612)
- [ENHANCEMENT] [v1.2] Bump RKE2 to v1.26.15+rke2r1 [#5596](https://github.com/harvester/harvester/issues/5596)
...
- [ENHANCEMENT] Bump LH to v1.5.5 in Harvester v1.2 [#5553](https://github.com/harvester/harvester/issues/5553)
...
- [backport v1.2] [ENHANCEMENT] upgrade: adapt Longhorn im-e/im-r pod unification [#5066](https://github.com/harvester/harvester/issues/5066)
- [ENHANCEMENT] Bump Longhorn to v1.5.4 in v1.2 branch [#5056](https://github.com/harvester/harvester/issues/5056)
...
- [backport v1.2] [ENHANCEMENT] Bump KubeVirt to 1.1.0-150500.8.6.1 [#4762](https://github.com/harvester/harvester/issues/4762)
- [backport v1.2] [ENHANCEMENT] Bump base images to SLE 15 SP5 [#4761](https://github.com/harvester/harvester/issues/4761)
...
- [FEATURE] Perform e2e tests on stable branches periodically [#2547](https://github.com/harvester/harvester/issues/2547)
...
- [BUG] registration of Harvester cluster in Rancher prime fails [#5723](https://github.com/harvester/harvester/issues/5723)
...
- [backport v1.2] [BUG] Using vmimage.status.storageClassName to fill volumeClaimTemplates [#5585](https://github.com/harvester/harvester/issues/5585)
...
- [BUG] Harvester chart marked as modified when upgrading to v1.2-head [#5566](https://github.com/harvester/harvester/issues/5566)
...
- [backport v1.2] [BUG] Duplicated WWN blockdevice [#5446](https://github.com/harvester/harvester/issues/5446)
...
- [backport v1.2] [BUG] Upgrade was stuck indefinitely in the "upgrade system services" phase due to fleet-agent unsuccessful registration [#5334](https://github.com/harvester/harvester/issues/5334)
...
- [BUG] VM can not migrate during upgrade [#5076](https://github.com/harvester/harvester/issues/5076)
...
- [backport v1.2] [BUG] Not-in-use Volume shows `Not Ready` and can not be use to create VM [#5036](https://github.com/harvester/harvester/issues/5036)
...
- [backport v1.2] [BUG] Persistent paths are not configured on master branch [#4797](https://github.com/harvester/harvester/issues/4797)
...
- [backport v1.2] [TASK] Bump embedded Rancher to v2.8.2 and RKE2 to v1.26.13+rke2r1 [#5089](https://github.com/harvester/harvester/issues/5089)
- [Doc] Storage network: considering backing image pods in IP Plan [#4244](https://github.com/harvester/harvester/issues/4244)
